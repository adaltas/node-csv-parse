...
Parser = function Parser() {
  ...
  var base, base1, base10, base11, base12, base13, base14, base15, base16, base17, base18, base2, base3, base4, base5, base6, base7, base8, base9, k, v;
  // @options = options
  this.options = {};
  for (k in options) {
    v = options[k];
  ...
  if ((base18 = this.options).encoding == null) {
    base18.encoding = 'utf-8';
  }
  // Counters
