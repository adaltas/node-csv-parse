...
class Parser extends Transform {
  constructor(opts = {}){
    ...
    if(options.bom === undefined || options.bom === null || options.bom === false){
      ...
      throw new CsvError(ErrorCode.InvalidOptionBOM, [
    ...
    if(options.cast === undefined || options.cast === null || options.cast === false || options.cast === ''){
      ...
      throw new CsvError(ErrorCode.InvalidOptionCast, [
    ...
    if(options.cast_date === undefined || options.cast_date === null || options.cast_date === false || options.cast_date === ''){
      ...
      throw new CsvError(ErrorCode.InvalidOptionCastDate, [
    ...
    if(options.columns === true){
      ...
      throw new CsvError(ErrorCode.InvalidOptionColumns, [
    ...
    if(options.columns_duplicates_to_array === undefined || options.columns_duplicates_to_array === null || options.columns_duplicates_to_array === false){
      ...
      throw new CsvError(ErrorCode.InvalidOptionColumnsDuplicatesToArray, [
    ...
    if(options.comment === undefined || options.comment === null || options.comment === false || options.comment === ''){
      ...
      if(!Buffer.isBuffer(options.comment)){
        throw new CsvError(ErrorCode.InvalidOptionComment, [
    ...
    if(options.delimiter.length === 0){
      throw new CsvError(ErrorCode.InvalidOptionDelimiter, [
    ...
    if(options.on_record === undefined || options.on_record === null){
      ...
      throw new CsvError(ErrorCode.InvalidOptionOnRecord, [
  ...
  __parse(nextBuf, end){
    ...
    for(pos = 0; pos < bufLen; pos++){
          ...
          if(this.state.quoting === true){
            ...
            if(escape !== null && chr === escape && nextChr === quote){
              ...
              const err = this.__error(
                new CsvError(ErrorCode.InvalidOptionClosingQuote, [
            ...
            if(this.state.field.length !== 0){
              ...
              if( relax === false ){
                const err = this.__error(
                  new CsvError(ErrorCode.InvalidOptionOpeningQuote, [
      ...
      if(this.state.commenting === false){
        if(max_record_size !== 0 && this.state.record_length + this.state.field.length > max_record_size){
          const err = this.__error(
            new CsvError(ErrorCode.MaxRecordSize, [
              'Max Record Size:',
      ...
      if( lappend === true && rappend === true ){
        ...
        const err = this.__error(
          new CsvError(ErrorCode.NonTrimableCharAfterClosingQuote, [
            'Invalid Closing Quote:',
    ...
    if(end === true){
      ...
      if(this.state.quoting === true){
        const err = this.__error(
          new CsvError(ErrorCode.QuoteNotClosed, [
            'Quote Not Closed:',
  ...
  __onRow(){
    ...
    if(recordLength !== this.state.expectedRecordLength){
      if(relax_column_count === true || 
        ...
        if(columns === false){
          const err = this.__error(
            new CsvError(ErrorCode.InconsistentRecordLength, [
          ...
          const err = this.__error(
            ...
            new CsvError(ErrorCode.RecordDontMatchColumnsLength, [
              'Invalid Record Length:',
  ...
  __firstLineToColumns(record){
    ...
    try{
      ...
      if(!Array.isArray(headers)){
        return this.__error(
          new CsvError(ErrorCode.InvalidColumnMapping, [
...
const parse = function(){
  ...
  for(let i in arguments){
    ...
    if(data === undefined && (typeof argument === 'string' || Buffer.isBuffer(argument))){
      ...
      throw new CsvError(ErrorCode.InvalidArgument, [
        'Invalid argument:',
