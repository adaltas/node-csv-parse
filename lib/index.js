...
Parser = function(options) {
  ...
  if ((base12 = this.options).auto_parse_custom == null) {
    base12.auto_parse_custom = false;
  }
  ...
  if ((base17 = this.options).skip_lines_with_empty_values == null) {
    base17.skip_lines_with_empty_values = false;
  }
  this.lines = 0;
  this.count = 0;
...
Parser.prototype.__write = function(chars, end) {
  ...
  auto_parse = (function(_this) {
    return function(value) {
      ...
      } else if (_this.options.auto_parse_custom) {
        value = _this.options.auto_parse_custom(value);
      }
      return value;
    };
  })(this);
